...
namespace Engine.GameObjects
{
    ...
    public class TextGameObject : GameObject
    {
        ...
        public TextGameObject(SpriteFont ff, float depth, Color color, Alignment alignment = Alignment.Left)
        {
            font = ff;
            Color = color;
            this.depth = depth;
        ...
        public override void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            // draw the text
            spriteBatch.DrawString(font, Text, this.GlobalPosition, Color, 0f, origin, 1, SpriteEffects.None, depth);
        }
        ...
        float OriginX
        {
            get
            {
                return alignment switch
                {
                    ...
                    Alignment.Left => 0,
                    // right-aligned
                    Alignment.Right => font.MeasureString(Text).X,
                    // centered
                    Alignment.Center => font.MeasureString(Text).X / 2f,
                    _ => 0,
                };
            }
        }
