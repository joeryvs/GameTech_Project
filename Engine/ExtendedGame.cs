...
namespace Engine
{
    public abstract class ExtendedGame : Game
    {
        ...
        protected Engine.Control.InputHelper inputHelper;
        ...
        /// custom property
        /// </summary>
        public Point GetWorldSize { get { return worldSize; } } // because i need it for the camara
        ...
        /// </summary>
        public static AssetManeger AssetManager { get; private set; }
        ...
        protected override void LoadContent()
        {
            ...
            AssetManager = new AssetManeger(Content);
        ...
        {
            inputHelper.UpdateTheStates(gametime);
